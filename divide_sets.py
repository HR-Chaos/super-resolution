...
hr_train_dir = 'data/HR_train'
lr_train_dir = 'data/LR_train'
hr_val_dir = 'data/HR_val'
lr_val_dir = 'data/LR_val'
hr_test_dir = 'data/HR_test'
lr_test_dir = 'data/LR_test'
...
train_files = hr_image_files[:15000]
...
val_files = hr_image_files[15000:16000]
...
for file_name in hr_image_files[16000:]:
    hr_src_path = os.path.join(hr_images_dir, file_name)
